...
word = input('Vvedite slovo: ').upper()
if N == 1:
	print('Za slovo', sum([k for i in word for k, v in eng.items() if i in v]), 'ochkov')
elif N == 0:
	print('Za slovo', sum([k for i in word for k, v in rus.items() if i in v]), 'ochkov')
else:
    print('neverniy vvod')